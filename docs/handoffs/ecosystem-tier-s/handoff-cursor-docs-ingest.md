...
> **진행 (2026-06-28):** CDOCS-00 ✅ · CDOCS-01 ✅ (cc-skills PR #6 `ac4a148`) · CDOCS-02 ✅ `p0-rules.md` · CDOCS-03 ✅ P0 6종 ingest(병렬 에이전트, bare URL, trust 5) + `cursor-docs-index.md`. 다음: CDOCS-04(P1 batch) 또는 마켓플레이스 반영.
...
| **CDOCS-03** | P0 나머지 5종 ingest | ✅ 6파일(rules·mcp·agent·context·skills·cli) + `cursor-docs-index.md`. 병렬 에이전트, bare URL, trust 5 |
