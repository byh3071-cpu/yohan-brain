...
guid: null
ingested_at: 2026-06-12T11:20:17.415Z
title_ko: 성공하는 방법
summary_ko: 수천 명의 창립자를 관찰한 결과, 많은 사람들이 처음에는 돈을 원하지만 결국 중요한 것을 만들고 싶어한다는 것을 알게
  되었습니다. 성공을 이루기 위한 13가지 생각 중 첫 번째는 '자신을 복리로 키우라'는 것입니다. 이는 경력에서 지속적으로 성장하고, 기회를
  놓치지 않으며, 장기적인 관점을 갖는 것이 중요하다는 것을 강조합니다. 또한, 자기 신념을 키우고 독립적으로 사고하는 능력을 기르는 것이
  성공에 필수적이라고 설명합니다.
---
...
**원문:** [열기](https://blog.samaltman.com/how-to-be-successful)
