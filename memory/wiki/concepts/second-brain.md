...
## 정의 (1~2문장)
- 개인의 지식·아이디어·메모를 체계적으로 외부에 저장하고 연결하는 시스템. 단순 기록이 아닌, 정보 간 연결이 새 의미를 생성하는 구조.

## Verified (소스 기반)
- 지식 베이스 = 단순 기록이 아닌, 정보 간 연결이 새 의미를 생성하는 구조 (Karpathy 관점). [source: knowledge-base-strategy]
- 원자적 노트(Atomic Notes) + 그래프 구조: 지식을 최소 단위로 분절 → AI가 자유롭게 재조합 가능. [source: knowledge-base-strategy]
